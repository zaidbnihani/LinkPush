...
fun UpdateCheckerEffect(
    ...
    updateInfo?.let { info ->
        UpdateDialog(
            ...
            onDownload = {
                ApkDownloaderAndInstaller.downloadAndInstallApk(
                    context = context,
                    ...
                    onError = { err ->
                        Toast.makeText(context, "فشل التنزيل: $err", Toast.LENGTH_LONG).show()
                    }
                )
                updateInfo = null
            }
    ...
    AlertDialog(
        ...
        text = {
            Column(
                ...
                if (isDownloading) {
                    ...
                    Text(
                        text = updateInfo.releaseNotes.ifBlank { "لا توجد تفاصيل إضافية لهذا الإصدار." },
                        style = MaterialTheme.typography.bodyMedium,
        ...
        confirmButton = {
            TextButton(
                ...
                Text(
                    text = if (isDownloading) "جاري التنزيل..." else "تثبيت الآن",
                    fontWeight = FontWeight.Bold
                )
            }
        },
